<template>
  <div>
    <div @click="openInfo" class="shadow flex flex-col relative">
      <div
        class="transition absolute z-10 w-12 h-12 top-0 border-4 border-white hover:bg-blue-800 right-0 m-2 flex justify-center items-center rounded-full"
        :class="color"
      >
